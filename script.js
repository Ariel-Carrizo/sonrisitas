...
document.getElementById("nombre").onclick = function () {
  Swal.fire({
    ...
    if (userName.value) {
      const usuarioNombre = userName.value;
      const nombre = [];
...
document.getElementById("pepe").onclick = function () {
  Swal.fire({
    text: "Yo soy Pepe el Hipo Verde, me gusta desayunar frutas y siempre lavarme los dientes despues de cada comida. ¡No dudes en elegirme para acompañarte a lavar los dientes esta vez!",
...
document.getElementById("pepo").onclick = function () {
  Swal.fire({
    text: "Yo soy Pepo el Hipo Verde, me gusta desayunar frutas y siempre lavarme los dientes despues de cada comida. ¡No dudes en elegirme para acompañarte a lavar los dientes esta vez!",
